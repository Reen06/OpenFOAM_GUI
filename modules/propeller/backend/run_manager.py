...
class RunManager:
    ...
    def create_run_from_mesh(
        ...
        try:
            ...
            # Copy UNV files to inputs and propCase
            shutil.copy2(rotor_path, run_dir / "inputs" / "rotor.unv")
            shutil.copy2(stator_path, run_dir / "inputs" / "stator.unv")
            shutil.copy2(rotor_path, run_dir / "propCase" / "rotor" / "rotor.unv")
    ...
    def create_run(
        ...
        """Legacy create_run - uses temp upload location."""
        ...
        try:
            ...
            shutil.copy2(rotor_src, run_dir / "propCase" / "rotor" / "rotor.unv")
