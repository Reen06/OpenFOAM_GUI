/**
 * WebSocket Manager for Live Log Streaming
 */
    ...
    _connect() {
        ...
        try {
            ...
            this.socket.onmessage = (event) => {
                ...
                console.log('[WS] Message received:', data.type, data.step || '');
            ...
            this.socket.onclose = () => {
                ...
                // If we're intentionally switching runs, don't touch buttons
                if (!this.intentionalClose) {
                    // Re-enable run button on disconnect to prevent stuck state
